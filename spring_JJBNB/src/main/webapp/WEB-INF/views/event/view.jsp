...
<%@include file="/resources/include/fix-header.jsp" %>
	...
	<main class="container main-box">
		...
		<section class="content">
			<img src="${pageContext.request.contextPath}/resources/assets/img/event_view1.jpg" alt="" style="width:100%; margin-top:50px;">
			<a href="${pageContext.request.contextPath}/event_list.do">
