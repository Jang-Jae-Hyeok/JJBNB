...
<div class="box-tong">
    ...
    <div class="info-down">
    	...
    	<a href="${pageContext.request.contextPath}/accommodation_payment.do">
   		 	<button class="w-btn w-btn-red" type="button">확인 및 결제</button>
   	 	</a>
</div>
<div class="payment-detail">
    <div class="top-content">
    <div class="img-view"><img src="${pageContext.request.contextPath}/resources/assets/img/숙소사진1.jpg" width="120px" height="120px"></div>
