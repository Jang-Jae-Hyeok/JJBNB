...
<nav class="main-reser-container">
    ...
    <div class="payment-check">
        ...
        <p class="p2">600,000원</p>
        <hr class="hr-pay">
        <p class="p1">결제일시</p>
        <p class="p2">2022년 9월 5일</p>
        <p class="p1">결제카드</p>
        <p class="p2">4518-****-****-052*</p>
        <p class="p1">예약일자</p>
        <p class="p2">12월 22일 ~ 12월 25일</p>
    ...
    <div class="img-check">
        <p class="img-nick">전주 파라다이스 호텔</p>
        <img src="${pageContext.request.contextPath}/resources/assets/img/숙소사진1.jpg">
    </div>
    </div>
