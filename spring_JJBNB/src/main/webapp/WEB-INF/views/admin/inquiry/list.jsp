		...
		<section class="content">
			<div class="content-list">
				<ul class="content-list-tap">
					<li><a href="${pageContext.request.contextPath}/admin_inquiry_list.do"><h6><span>회원 문의내역&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h6></a></li>
					<li><a href="${pageContext.request.contextPath}/admin_inquiry_answer.do"><h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;답변완료 내역</h6></a></li>
				</ul>
				<hr>
