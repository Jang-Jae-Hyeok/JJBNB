	...
	<main class="container main-box">
		 ...
		 <nav class="side-nav">
			<dl class="side-nav-title">
				...
				<dd><a href="${pageContext.request.contextPath}/admin_member_del_list.do"><span>회원정보 삭제 내역</span></a></dd>
			...
			<div align="center">
				...
				<table>
					<tr>
						...
						<td>닉네임</td><td>전화번호</td><td>등급</td><td>가입일자</td><td>탈퇴날짜</td><td>탈퇴취소</td>
					</tr>
					...
					<tr>
						...
						<td>2022-09-06</td>
						<td>
							<button class="adminUpdateInfo" name="">취소</button>
						</td>
					</tr>
