				...
				<div class="content-list">
					<ul>
						<li>
							...
							<input type="text" class="text_type_1" value="[공지] 서비스 점검 안내(09/05 02:00 ~ 06:00)" placeholder="제목을 작성해주세요."/>
						</li>
					</ul>
					...
					<ul>
						<section class="text_wrap">
							<p>공지 내용</p>
								<div>
									<textarea name="content" id="questionTextarea" placeholder="공지하실 내용을 10자 이상 입력해 주세요.">
안녕하세요. JJBNB 입니다.

더 나은 서비스 제공을 위한 점검 안내드립니다.
점검 시간 동안에는 JJBNB 메일 알림 서비스 이용이 일시중지됩니다.

서비스 점검 안내
&nbsp; -일시 : 2022년 09월 05일 02:00 ~ 06:00 (4시간)
&nbsp; -영향 : JJBNB 메일 알림 서비스 중단
...
&nbsp; 감사합니다.
				...
				<button class="btn_red_fill" type="submit" onclick="">수정 완료</button>
			</form>
		</section>
	</main>
