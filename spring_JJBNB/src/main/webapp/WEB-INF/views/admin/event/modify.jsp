	...
	<main class="container main-box">
		 ...
		 <nav class="side-nav">
			<dl class="side-nav-title">
				...
				<dd><a href="${pageContext.request.contextPath}/admin_event_list.do"><span>이벤트 관리</span></a></dd>
				...
				<div class="content-list">
					<ul>
						<li>
							...
							<input type="text" class="text_type_1" value="22년 9월 결제 프로모션 모음" placeholder="제목을 작성해주세요."/>
						</li>
					</ul>
					...
					<ul>
						<li>
							...
							<input type="text" class="text_type_1" value="event1.jpg" placeholder="파일을 첨부해주세요."/>
						</li>
					</ul>
				</div>
