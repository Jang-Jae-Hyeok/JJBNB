		...
		<section class="content">
			<div class="content-list">
				<ul class="content-list-tap">
					<li><a href="${pageContext.request.contextPath}/inquiry_list.do"><h6><span>나의 문의내역&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h6></a></li>
					<li><a href="${pageContext.request.contextPath}/inquiry_write.do"><h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;새 문의 작성</h6></a></li>
				</ul>
				<hr>
